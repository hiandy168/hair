	...
	<div id="sidebar" class="nav-collapse collapse">
      ...
      <div id="main-content">
        ...
        <div class="container-fluid">
          ...
          <!-- END PAGE HEADER-->
          <form action="<?php echo (C("ACTION_BASE_DIR")); ?>/admin/adminUpdate/" class="form-horizontal" id="admin_form" method="post">
            
            <?php if($upd_kbn == '0'): ?><div class="row-fluid">
                <div class="span12">
                  <div class="widget">
            ...
            <?php if($upd_kbn == '1'): ?><div class="row-fluid">
                <div class="span12">
                  <div class="widget">
                    <div class="widget-title">
            ...
            <?php if($upd_kbn == '2'): ?><div class="row-fluid">
                <div class="span12">
                  <div class="widget">
                    <div class="widget-title">
                    	...
                    	<?php if(is_array($adminRoleList)): $i = 0; $__LIST__ = $adminRoleList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$admin_role_list): $mod = ($i % 2 );++$i; if($admin_role_list["parent_role_id"] == 0): ?><div class="control-group">
    				                  <label class="control-label">
    				                  	<label class="checkbox">
    				                  		<?php $action_list = $obj_admin["action_list"]; ?>
    				                  		<?php $action_code = $admin_role_list["action_code"]; ?>
    				                  		<?php if(stripos($action_list,$action_code) !== false): ?><input type="checkbox" onClick="checkBoxAll(this)" name="action_code[]" class="role_id_all" value="<?php echo ($admin_role_list["action_code"]); ?>" checked/><?php echo ($admin_role_list["role_name"]); ?>
    	                            <?php else: ?>
    	                            	<input type="checkbox" onClick="checkBoxAll(this)" name="action_code[]" class="role_id_all" value="<?php echo ($admin_role_list["action_code"]); ?>"/><?php echo ($admin_role_list["role_name"]); endif; ?>
    	                          </label>
    				                  </label>
    				                  <div class="controls">
    				                  	<?php $role_id = $admin_role_list["role_id"]; ?>
    				                  	<?php if(is_array($adminRoleList)): $i = 0; $__LIST__ = $adminRoleList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub_admin_role_list): $mod = ($i % 2 );++$i; $sub_action_code = $sub_admin_role_list["action_code"]; ?>
    				                  		<?php if($sub_admin_role_list["parent_role_id"] == $role_id): ?><label class="checkbox">
    					                  				<?php if(stripos($action_list,$sub_action_code) !== false): ?><input type="checkbox" value="<?php echo ($sub_admin_role_list["action_code"]); ?>" name="action_code[]" onClick="checkBox(this)" checked/><?php echo ($sub_admin_role_list["role_name"]); ?>
    				                            <?php else: ?>
    				                            	<input type="checkbox" value="<?php echo ($sub_admin_role_list["action_code"]); ?>" name="action_code[]" onClick="checkBox(this)"/><?php echo ($sub_admin_role_list["role_name"]); endif; ?>
            ...
            <div class="row-fluid">
              <div class="span6">
                <center>
                  <input type="hidden" class="span5" name="admin_id" value="<?php echo ($obj_admin["admin_id"]); ?>"/>
                  <input type="hidden" class="span5" name="upd_kbn" value="<?php echo ($upd_kbn); ?>"/>
