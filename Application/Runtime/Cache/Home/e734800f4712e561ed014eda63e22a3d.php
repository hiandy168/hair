              ...
              <div class="widget">
                <div class="widget-body">
                  <table class="table table-striped table-bordered" id="data">
                    <thead>
                      <tr>
                        <th style="width:20%;">管理员用户名</th>
                        <th style="width:20%;">管理员邮箱</th>
                        <th style="width:20%;">管理员姓名</th>
                    ...
                    <tbody>
                      <?php if(is_array($adminlist)): $i = 0; $__LIST__ = $adminlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$admin): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                          ...
                          <td>
                            <button class="btn btn-primary" onClick="admin_update('<?php echo ($admin["admin_id"]); ?>','0')">修改基本信息</button>
                            <button class="btn btn-primary" onClick="admin_update('<?php echo ($admin["admin_id"]); ?>','1')">修改密码</button>
                            <button class="btn btn-primary" onClick="admin_update('<?php echo ($admin["admin_id"]); ?>','2')">分配权限</button>
                            <button class="btn btn-danger" onClick="admin_delete('<?php echo ($admin["admin_id"]); ?>','<?php echo ($admin["admin_name"]); ?>')">删除</button>
                          </td>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                  </table>
                  <button class="btn btn-primary" onClick = "adminAdd()">添加管理员</button>
                </div>
              </div>
