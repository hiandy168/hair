					...
					<div class="span12">
						...
						<div class="widget">
							<div class="widget-body">
								<!-- BEGIN FORM-->
								<form
									action="<?php echo (C("ACTION_BASE_DIR")); ?>/service/serviceAdd/"
									...
									<div class="control-group">
										...
										<div class="controls">
											<select class="chzn-select span5" tabindex="1"
												...
												<?php if(is_array($serviceTypeList)): $i = 0; $__LIST__ = $serviceTypeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$service_type): $mod = ($i % 2 );++$i;?><option value="<?php echo ($service_type["type_id"]); ?>"><?php echo ($service_type["type_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
											</select>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<select class="chzn-select span5" tabindex="1"
												...
												<?php if(is_array($serviceCategoryList)): $i = 0; $__LIST__ = $serviceCategoryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$service_category): $mod = ($i % 2 );++$i;?><option value="<?php echo ($service_category["category_id"]); ?>"><?php echo ($service_category["category_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
											</select>
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" placeholder="手工费" class="span5"
												name="hand_price" />
										</div>
									</div>
