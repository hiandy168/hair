              ...
              <div class="widget">
                <div class="widget-body">
                  ...
                  <table class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        <th style="vertical-align: middle;text-align: center;" width="20">编号</th>
                        <th style="vertical-align: middle;text-align: center;width:100px;" width="100">名称</th>
                        <th style="vertical-align: middle;text-align: center;width:70px;" width="70">类型</th>
                        <th style="vertical-align: middle;text-align: center;width:630px;" width="630">详细内容
                        	<table style="width:100%;" class="header_inner">
                        		<tr>
			                     	<th style="vertical-align: middle;text-align: center;width:45px;" width="45">编号</th>
			                     	<th style="vertical-align: middle;text-align: center;width:200px;" width="200">项目名称</th>
			                     	<th style="vertical-align: middle;text-align: center;width:45px;" width="45">次数</th>
			                     	<th style="vertical-align: middle;text-align: center;width:50px;" width="50">单价</th>
			                     	<th style="vertical-align: middle;text-align: center;width:50px;" width="50">总价</th>
			                     	<th style="vertical-align: middle;text-align: center;width:50px;" width="50">有效期</th>
			                     </tr>
                        	</table>
                        </th>
                        <th style="vertical-align: middle;text-align: center;width:20px;" width="20">操作</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php if(is_array($courseList)): $i = 0; $__LIST__ = $courseList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$course): $mod = ($i % 2 );++$i;?><tr>
                      		<td style="vertical-align: middle;text-align: center;width: 20px;"><?php echo ($course["course_id"]); ?></td>
                      		<td style="vertical-align: middle;text-align: center;width: 100px;"><?php echo ($course["course_name"]); ?></td>
                      		<td style="vertical-align: middle;text-align: center;width: 70px;"><?php echo ($course["category_name"]); ?></td>
                      		<td style="vertical-align: middle;text-align: center;width:630px;">
                      			<table style="width:100%;" class="header_inner">
	                  				<assign name = "course_id" value= "$course.course_id">
	                  				<?php if(is_array($courseServiceList)): $i = 0; $__LIST__ = $courseServiceList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$course_service_list): $mod = ($i % 2 );++$i;?><assign name = "service_course_id" value= "$course_service_list.course_id">
	                  					<?php if($service_course_id == $course_id): ?><tr style="border-bottom: 1px #ddd solid;">
	                    						<td style="vertical-align: middle;text-align: center;width:30px;"><?php echo ($course_service_list["service_id"]); ?></td>
	                    						<td style="vertical-align: middle;text-align: center;width:200px;"><?php echo ($course_service_list["service_name"]); ?></td>
	                    						<td style="vertical-align: middle;text-align: center;width:30px;"><?php echo ($course_service_list["usecount"]); ?></td>
	                    						<td style="vertical-align: middle;text-align: center;width:50px;"><?php echo ($course_service_list["signal_price"]); ?></td>
	                    						<td style="vertical-align: middle;text-align: center;width:50px;"><?php echo ($course_service_list["course_service_price"]); ?></td>
	                    						<td style="vertical-align: middle;text-align: center;width:50px;">
	                    							<assign name = "course_service_type" value= "$course_service_list.course_service_type">
	                    							<?php if($course_service_type == 0): echo ($course_service_list["course_service_days"]); ?>天
	                    							<?php else: ?>
	                    								<?php echo ($course_service_list["course_service_date"]); endif; ?>
	                    						</td>
	                    					</tr><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                  				</table>
                  			</td>
                      		<td>
	                            <button class="btn btn-danger" onClick="courseDelete('<?php echo ($course["course_id"]); ?>')">删除</button>
	                          </td>
                  ...
                  <button class="btn btn-primary" onClick = "courseAdd()">添加套餐</button>
                  <button class="btn btn-primary" onClick = "courseCategoryAdd()">添加套餐类型</button>
                </div>
              </div>
