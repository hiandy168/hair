        ...
        <div class="container-fluid">
          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <h3 class="page-title">添加服务项目类型</h3>
          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <form action="<?php echo (C("ACTION_BASE_DIR")); ?>/service/serviceCategoryProcess/" id="service_type_category" method="post">
                
                <div class="widget">
                  <div class="widget-body">
                    <div class="row-fluid">
                    	<?php if(is_array($serviceCategoryList)): $i = 0; $__LIST__ = $serviceCategoryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$service_category): $mod = ($i % 2 );++$i;?><div class="span3">    
                          <input type="hidden" placeholder="" class="span12" name="category_id[]" value="<?php echo ($service_category["category_id"]); ?>"/>
                  				<input type="text" placeholder="" class="span12" name="category_name[]" value="<?php echo ($service_category["category_name"]); ?>" onfocus ="add_category(this);"/>
                				</div><?php endforeach; endif; else: echo "" ;endif; ?>
              			</div>
                  </div>
                </div>
                <div class="form-actions">
                  <button class="btn btn-large btn-success" type="button" onClick="form_service_type_category_submit();">提交</button>
