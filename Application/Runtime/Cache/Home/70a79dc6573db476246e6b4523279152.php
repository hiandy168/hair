	...
	<div id="sidebar" class="nav-collapse collapse">
      ...
      <div id="main-content">
        <div class="container-fluid">
          <div class="row-fluid">
            <div class="span12">
              <h3 class="page-title">添加套餐类型</h3>
            </div>
          </div>
          <div class="row-fluid">
            <div class="span12">
              <form action="<?php echo (C("ACTION_BASE_DIR")); ?>/course/courseCategoryProcess/" id="course_category" method="post">
                <?php if($dataCount == 0): ?><div class="widget">
                    <div class="widget-body">
                      <div class="row-fluid">
                        <div class="span3">    
                          <input type="hidden" placeholder="" class="span12" name="category_id[]" value="<?php echo ($course_category["category_id"]); ?>"/>
                          <input type="text" placeholder="" class="span12" name="category_name[]" value="<?php echo ($course_category["category_name"]); ?>" onfocus ="add_text_box(this);"/>
                        </div>
                      </div>
                    </div>
                  </div>
                <?php else: ?>
                  <div class="widget">
                    <div class="widget-body">
                			<div class="row-fluid">
                        <?php if(is_array($courseCategoryList)): $i = 0; $__LIST__ = $courseCategoryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$course_category): $mod = ($i % 2 );++$i;?><div class="span3">    
                            <input type="hidden" placeholder="" class="span12" name="category_id[]" value="<?php echo ($course_category["category_id"]); ?>"/>
                            <input type="text" placeholder="" class="span12" name="category_name[]" value="<?php echo ($course_category["category_name"]); ?>" onfocus ="add_text_box(this);"/>
                  ...
                  <button class="btn btn-large btn-success" type="button" onClick="form_course_category_submit(this);">提交</button>
