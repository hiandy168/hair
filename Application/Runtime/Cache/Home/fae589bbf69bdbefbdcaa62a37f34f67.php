                  ...
                  <table class="table table-striped table-bordered" id="data">
                    ...
                    <tbody>
                      <?php if(is_array($serviceList)): $i = 0; $__LIST__ = $serviceList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$service): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                          ...
                          <td>
                            <button class="btn btn-primary" onClick="serviceUpdate('<?php echo ($service["service_id"]); ?>')">修改</button>
                            <button class="btn btn-danger" onClick="serviceDelete('<?php echo ($service["service_id"]); ?>')">删除</button>
                          </td>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                  </table>
                  <button class="btn btn-primary" onClick = "serviceAdd()">添加服务项目</button>
                  <button class="btn btn-primary" onClick = "serviceTypeCategoryAdd()">添加类型</button>
