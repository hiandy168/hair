            ...
            <div class="span12">
              <div class="widget">
                <div class="widget-body">
                  <?php if($serviceCount != 0 ): ?><table class="table table-bordered table-hover table-header">
                      <thead>
                        <tr>
                          <th class="span3">编号</th>
                          <th class="span3">名称</th>
                          <th class="span3">类型</th>
                          <th class="span3">类别</th>
                          <th class="span3">价格</th>
                          <th class="span3">手工费</th>
                      ...
                      <tbody>
                        <?php if(is_array($serviceList)): $i = 0; $__LIST__ = $serviceList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$service): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                            ...
                            <td><?php echo ($service["hand_price"]); ?></td>
                            <td>
                              <button class="btn btn-primary" onClick="toLink('/service/toServiceUpdate/','{service_id:<?php echo ($service["service_id"]); ?>}')">修改</button>
                              <button class="btn btn-danger" onClick="ajaxRequest('/service/serviceDelete/','/service/serviceList/','{service_id:<?php echo ($service["service_id"]); ?>,service_name:\'<?php echo ($service["service_name"]); ?>\'}','确定删除？')">删除</button>
                            </td>
                  ...
                  <button class="btn btn-primary" onClick = "toLink('/service/toServiceAdd/','')">添加服务项目</button>
                  <button class="btn btn-primary" onClick = "toLink('/service/toServiceCategoryProcess/','')">添加类型</button>
                  <button class="btn btn-primary" onClick = "serviceTypeCategoryAdd()">批量导入服务项目</button>
                </div>
              </div>
            </div>
          </div>
