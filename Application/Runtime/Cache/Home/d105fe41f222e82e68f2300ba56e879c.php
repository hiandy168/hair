			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">添加会员卡类型</h3>
					...
					<div class="span12">
						...
						<div class="widget">
							<div class="widget-body">
								<!-- BEGIN FORM-->
								<form
									action="<?php echo (C("ACTION_BASE_DIR")); ?>/member/memberCardTypeAdd/"
									class="form-horizontal" id="card_type_form">
									<div class="control-group">
										<label class="control-label">会员卡类型名称:</label>
										<div class="controls">
											<input type="text" placeholder="会员卡类型名称" class="span5"
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" placeholder="项目折扣" class="span5"
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" placeholder="套餐折扣" class="span5"
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea class="span5" rows="3" name="comment"></textarea>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<label class="radio"> <input type="radio"
												name="is_lock" value="1" />是
											</label> <label class="radio"> <input type="radio"
												name="is_lock" value="0" checked />否
											</label>
										</div>
									</div>
									<div class="form-actions">
										<button type="button" class="btn btn-large btn-success"
											onClick="form_card_type_submit()">提交</button>
									</div>
								</form>
								<!-- END FORM-->
							</div>
