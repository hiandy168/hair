        ...
        <div class="container-fluid">
          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <form action="<?php echo (C("ACTION_BASE_DIR")); ?>/employee/employeePositionProcess/" id="employee_position" method="post">
                <?php $employee_postion_big_count = '0'; ?>
                <?php if(is_array($employeePositionBigList)): $i = 0; $__LIST__ = $employeePositionBigList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$employee_postion_big): $mod = ($i % 2 );++$i;?><div class="widget">
                      <div class="widget-title">
                        <h4><i class="icon-reorder"></i></h4>
                        <input type="hidden" placeholder="" class="span5" style="margin:3px 0px 0px 0px;" name="employee_position_big_id[]" value="<?php echo ($employee_postion_big["employee_position_big_id"]); ?>"/>
                        <input type="text" placeholder="" class="span5" style="margin:3px 0px 0px 0px;" name="employee_position_big_name[]" value="<?php echo ($employee_postion_big["employee_position_big_name"]); ?>"/>
                        <span class="tools">
                          <a class="icon-chevron-down" href="javascript:;"></a>
                          <a class="icon-plus" href="javascript:;" onClick="add_category_sub(this,'<?php echo ($employee_postion_big["employee_position_big_id"]); ?>')"></a>
                        </span>
                      </div>
                      <div class="widget-body">
                        ...
                        <?php if(is_array($employeePositionList)): $i = 0; $__LIST__ = $employeePositionList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$employee_postion): $mod = ($i % 2 );++$i; $employee_postion_sub_id = $employee_postion["employee_position_big_id"]; ?>
                          <?php if($employee_postion_big_id == $employee_postion_sub_id): ?><input type="hidden" placeholder="" class="span12" name="employee_position_id<?php echo ($employee_postion_big_count); ?>[]" value="<?php echo ($employee_postion["employee_position_id"]); ?>"/>
                            <input type="text" placeholder="" class="span12" name="employee_position_name<?php echo ($employee_postion_big_count); ?>[]" value="<?php echo ($employee_postion["employee_position_name"]); ?>"/><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                        <input type="hidden" placeholder="" class="span12" name="employee_position_id<?php echo ($employee_postion_big_count); ?>[]" value=""/>
                        <input type="text" placeholder="" class="span12" name="employee_position_name<?php echo ($employee_postion_big_count); ?>[]" value=""/>
                        <?php $employee_postion_big_count = $employee_postion_big_count + 1; ?>
                      </div>
                    </div><?php endforeach; endif; else: echo "" ;endif; ?>
                
              	<input type="hidden" placeholder="" class="span12" name="data_count" value="0"/>
              	<div class="form-actions">
                  <button class="btn btn-large btn-success" type="button" onClick="form_position_submit();">提交</button>
